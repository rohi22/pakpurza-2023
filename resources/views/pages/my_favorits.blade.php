      ...
      <div class="row">
        <div class="col-md-3">
          <div class="dashboard_menu">
            ...
            <ul class="list-unstyled  m-t-20">
              ...
              <li class="active"><span><i class="fa fa-heart"></i></span><a href="24-My_Favorits-Page.html"> My Favourites </a></li>
        ...
        <div class="col-md-9">
          <div class="dashboard_main">
            <div class="dashboard_profile m-b-30 d-flex justify-content-between">
              <div class="profile_setting text-capitalize">
                <h3>My Favourites</h3>
              </div>
              <div class="my_favourites text-capitalize"><a href="#">Favourites (88)</a></div>
            </div>
