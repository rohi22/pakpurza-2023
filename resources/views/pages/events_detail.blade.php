  ...
  <div class="text-center">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="04-Events_Detail-Page-Page.html"> News </a></li>
      </ol>
    </nav>
  </div>
  <!-- Column --> 
  ...
  <div class="col-md-9 col-sm-12 col-xs-12">
    <div class="blog-post"> 
      ...
      <div class="single-blog-post">
        <div class="img-holder"> <div class="img_up"><img src="images/News1.png"  alt="Pak Purza"></div>
          ...
          <div class="text m-t-30">
            ...
            <a class="readmore" href="07-News_Detail-Page.html">Continue Reading<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> </div>
        </div>
      </div>
      <div class="single-blog-post">
        <div class="img-holder"><div class="img_up"> <img src="images/News2.png"  alt="Pak Purza"></div>
          <div class="overlay-style-two">26<br>
            February</div>
          <div class="date_more">
            <div class="text-holder">
