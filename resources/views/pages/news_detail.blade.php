  ...
  <div class="text-center">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="07-News_Detail-Page.html"> News Detail </a></li>
      </ol>
    </nav>
  </div>
  <!-- Column --> 
  ...
  <div class="col-md-9 col-sm-12 col-xs-12">
    <div class="blog-post"> 
      ...
      <div class="single-blog-post">
        <div class="img-holder"> <div class="img_up"><img src="images/News1.png" alt="Classified Plus"></div>
        ...
        <div class="media2">
          ...
          <div class="d-flex"> <img class="media-object icon-space align-self-top" src="images/News4.png" alt="Classified Plus">
        ...
        <div class="media2">
          ...
          <div class="d-flex"> <img class="media-object icon-space align-self-top" src="images/News5.png" alt="Classified Plus">
            <div class="media-body">
        ...
        <hr>
        <div class="media2">
          <div class="d-flex"> <img class="media-object icon-space align-self-top" src="images/News6.png" alt="Classified Plus">
            <div class="media-body">
              <h4 class="media-heading">Johny Rewalt<br>
                <small>17 August 2015 at 12.00pm / <a href="#">Reply</a></small></h4>
