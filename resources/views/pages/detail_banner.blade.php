...
<!-- banner -->
<section class="banner banner_datile">
    <div class="banner-innerpage datile_banner">
      <div class="container"> 
        <!-- Row  -->
          ...
          <div class="text-center">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="12-Datile_banner-Page.html"> Detail </a> </li>
              </ol>
            </nav>
          </div>
          <!-- Column --> 
