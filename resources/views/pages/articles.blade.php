          ...
          <div class="text-center">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> <a href="04-Articles-Page.html"> All Articles</a></li>
              </ol>
            </nav>
          </div>
          <!-- Column -->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
          <a href="07-Article_Detail-Page.html">
            <div class="trending-parts bg-light rounded m-t-30">
              <div class="trending-img"> <img class="img-fluid rounded-top" src="images/Trending-img-1.png"
                  alt="Pak Purza" />
              ...
              <div class="trending-text p-t-25 p-b-20 p-l-15 p-r-15">
                <div class="text-top d-flex justify-content-between  m-t-15 p-b-10">
                  <div class="trending-left"><a href="#" class="m-r-5"><i class="fa fa-heart-o"></i> 5</a> <a
                      href="#"><i class="fa fa-comment-o"></i> 8</a> </div>
