...
<div class="modal fade show pr-17" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-modal="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y overflow-hidden height-200" data-scroll="true" data-height="200">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x bottom-left"><div class="ps__thumb-x l-w-0" tabindex="0"></div></div><div class="ps__rail-y height-200 top-right"><div class="ps__thumb-y t-130-h-70" tabindex="0"></div></div></div>
            </div>
