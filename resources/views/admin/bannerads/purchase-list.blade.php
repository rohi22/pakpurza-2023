...
@section('title')
Simsar | Purchases Banner Ads List
@endsection
                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                @if($purchasesbannerads->count() > 0)
                                @foreach ($purchasesbannerads as $key=>$p)
                                    <tr>
                                       
                                        <th scope="row" class="center"> {{$key + $purchasesbannerads->firstItem()}}</th>
                                        ...
                                        <td align="center">
                                            @if(!empty($p->banner_img))
                                                <img src="{{URL::asset('public/assets/media/buybannersplans/'.$p->banner_img)}}" att="{{$p->Plan_title}}" style="height:100px; width:300px;">
                                            @else
                                                <img src="{{URL::asset('public/assets/media/no_image.jpg')}}" att="{{$p->Plan_title}}" style="height:100px; width:100px;">
                                            @endif
                                        </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y overflow-hidden h-200" data-scroll="true" data-height="200">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-0-b-365"><div class="ps__thumb-x l-w-0" tabindex="0"></div></div><div class="ps__rail-y h-200 t-365-r-0"><div class="ps__thumb-y t-130-h-70" tabindex="0"></div></div></div>
            </div>
...
<div class="modal fade show pr-17-px" id="approveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
           <input type="hidden" id="deleteId">
            <div class="modal-body pt-5-pb-11">
                <center>
                    <i class="la la-info-circle color-fb-fs-70"></i><br><br>
                    <h3>Are you sure?</h3>
...
<!--//made by h-->
<div class="modal fade show pr-17-px" id="rejectmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
...
<div class="modal fade show pr-17-px" id="userModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body pt-5-pb-11">
                <center>
...
$("#approveRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('admin/approve-banner-plans/') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
        ...
        success:function(data){
           ...
           if(data==1){
                ...
                toastr.success('Record Approve', 'Deleted');
...
$("#rejectRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('admin/reject-banner-plans/') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
