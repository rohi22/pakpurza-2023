...
@section('title')
Simsar | Bump Up Control Setting
@endsection
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('update-bump-up-setting')}}" method="POST"   enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                @if($bumpupsetting->count() > 0)
                                @foreach ($bumpupsetting as $key=>$s)
                                    <tr>
                                       
                                        <th scope="row" class="center">{{$key + $bumpupsetting->firstItem()}}</th>
                                        <td>{{ucfirst($s->getPage->page_title)}} <input type="hidden" name="field_id[]" value="{{$s->id}}"></td>
                                        <td>
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            ...
                            <a href="{{url('bumup-ads-setting')}}" type="reset" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
