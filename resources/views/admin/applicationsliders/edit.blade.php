...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('update-application-slider/'.$slide->id)}}" method="POST"   enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                <div class="row pb-1-percentage">
                    <div class="col-md-12 text-right">
                        <a href="{{url('application-slider')}}"><button type="button" class="btn btn-primary"><i class="fa fa-eye"></i>View Slider Listing</button></a>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                            <div class="kt-avatar__holder" style="width:350px; height:220px; background-image: url(https://minibigerp.com/simsar/public/assets/media/applicationslider/{{ $slide->slide }});"></div>
