        ...
        <div class="kt-portlet__body">
            <div class="row p-b-1per">
                <div class="col-md-12 text-right">
                    <a href=""><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Account</button></a>
                </div>
            </div>
                        ...
                        <table class="table table-bordered" width="100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%;">Title of Account</th>
                                    <th width="10%;" class="center">User ID</th>
                                    <th width="10%;" class="center">User Name</th>
                                    <th width="10%;" class="center">Account No.</th>
                                    <th width="17%;"  class="center">Bank Name</th>
                                    <th width="8%;"  class="center">Branch Code</th>
                                    <th width="10%;" class="center">Branch Address</th>
                                    <th width="10%;" class="center">IBAN No.</th>
                                    <th width="15%;"  class="center">Swift Code</th>
