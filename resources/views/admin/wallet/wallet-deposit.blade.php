...
@section('title')
Simsar | Wallet Deposite Requests
@endsection
        ...
        <div class="kt-portlet__body">
            <div class="row p-b-1per" >
                <div class="col-md-12 text-right">
                    <a href="{{url('create-category')}}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Deposite</button></a>
                </div>
            </div>
