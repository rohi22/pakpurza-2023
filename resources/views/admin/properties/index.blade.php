    ...
    <div class="kt-portlet kt-portlet--height-fluid">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    Properties for <a href="{{url('attributes/'.$attribute->sub_category_id)}}">{{ucfirst($attribute->title)}}</a>
                </h3>
            </div>
        ...
        <div class="kt-portlet__body">
            ...
            <div class="col-md-8"></div>    
                ...
                <div class="col-md-2 text-right">
                    <a href="{{url('create-property/'.$attribute->id)}}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Property For {{ucfirst($attribute->title)}}</button></a>
                </div>
            </div>
                        ...
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                ...
                                @foreach ($properties as $key=>$property)
                                    <tr>
                                        <input type="hidden" id="description{{$property->id}}" value="{{$property->description}}">
                                        <th scope="row" class="center"> <input type="checkbox" value="{{$property->id}}" name="properties[]" >  {{++$key}}</th>
                                        <td >{{ucfirst($property->title)}}</td>
                                        <td align="center"><a href="javascript:;" class="descriptionModal" data-id="{{$property->id}}"><i class="fa fa-eye"></i></a></td>
                                        <td align="center">
                                            <a href="{{url('edit-property/'.$property->id)}}"><button type="button" class="btn btn-type btn-primary btn-sm btn-icon"  data-placement="top" data-content="Edit" title="edit"><i class="fa fa-edit"></i></button>
                                            <a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-type btn-danger  btn-sm btn-icon"  data-id="{{$property->id}}" data-placement="top" data-content="Delete" title="delete"><i class="fa fa-trash"></i></button></a>
                                        </td>
                                    </tr>    
                                @endforeach
                                @else
...
$("#deleteRecord").click(function(){
  ...
  $('#btbdeleteall').click(function(){
        var values = $("input[name='properties[]']:checked")
