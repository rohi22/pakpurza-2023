        ...
        <form action="{{url('store-category')}}" method="POST" enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                       <input type="file" name="icon"  id="upload_image_second" class="checkImageValid w-100per" required >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input name='meta_keywords' required placeholder="Add users" value="Chris Muller, Lina Nilson" >
                    </div>
