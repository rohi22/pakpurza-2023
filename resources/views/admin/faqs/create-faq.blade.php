...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{ url('admin/save-faq') }}" method="POST" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <textarea id="kt_maxlength_1" name="q" class="form-control"  maxlength="255" placeholder="" rows="2" placeholder="Enter Description"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        <label>Answer</label>
                        <textarea id="kt_maxlength_1" name="a" class="form-control"  maxlength="255" placeholder="" rows="2" placeholder="Enter Description"></textarea>
                    </div>
                </div>
