        ...
        <div class="kt-portlet__body">
            <div class="row p-b-1per" >
                <div class="col-md-12 text-right">
                    <a href="{{url('admin/create-faq')}}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Faq</button></a>
                </div>
            </div>
                                ...
                                @if(!empty($faqs))
                                        @foreach($faqs as $key=>$faq)
                                            <tr>
                                                ...
                                                <td>{{ $faq->question }}</td>
                                                <td>{{ $faq->answer }}</td>
                                                <!--<td>{{ isset($faq->getCat->title) ? $faq->getCat->title : '' }}</td>-->
                                                <td>{{ $faq->created_at }}</td>
                                                <td>

<a href="{{url('admin/edit-faq/'.$faq->id)}}"><button type="button" class="btn btn-type btn-primary btn-sm btn-icon" data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button></a>
<a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-type btn-danger  btn-sm btn-icon"  data-id="{{$faq->id}}" data-placement="top" data-content="Delete"><i class="fa fa-trash"></i></button></a>
                                           
                                           
<!--<a onclick="return confirm('Are You Sure')" href="{{url('admin/delete-faq/'.$faq->id)}}"><i class="ti-trash"></i></a> | -->
<!--<a href="{{url('admin/edit-faq/'.$faq->id)}}" class="text-success"><i class="ti-pencil-alt"></i></a>-->
