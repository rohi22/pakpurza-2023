...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{ url('admin/pages/update-page/'.$page->id) }}" method="POST"   enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <!--<textarea id="kt_maxlength_1" name="content" class="form-control"  maxlength="255" placeholder="" rows="2" placeholder="Enter Description">{{ $page->content }}</textarea>-->
                        
                        <textarea id="kt-tinymce-2" name="content" class="tox-target">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                            <div class="kt-avatar__holder" style="background-image: url({{ asset('public/images/common-pages/'.$page->image) }});"></div>
                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
                                <i class="fa fa-pen"></i>
                                <input type="file" name="image" class="checkImageValid w-100per" id="upload_image_second"  >
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-12 text-right">
                            ...
                            <a href="{{url('admin/pages',$page->id)}}" type="reset" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
