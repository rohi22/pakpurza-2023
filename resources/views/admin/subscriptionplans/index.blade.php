                        ...
                        <table class="table table-bordered" width="100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%;">Cost</th>
                                    <th width="25%;">Duration In Days</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($subscriptionplans as $key=>$subscriptionplan)
                                    <tr>
                                        ...
                                        <td >{{ucfirst($subscriptionplan->title)}}</td>
                                     <td >{{$subscriptionplan->no_of_post}}</td>
                                      <td >{{$subscriptionplan->cost}}</td>
                                       ...
                                       <td>
                                        ...
                                        <td align="center">
                                            <a href="{{url('admin/edit-subscription-plans/'.$subscriptionplan->id)}}"><button type="button" class="btn btn-brand btn-primary btn-sm btn-icon" data-toggle="kt-popover" data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button>
                                            <a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-brand btn-danger  btn-sm btn-icon" data-toggle="kt-popover" data-id="{{$subscriptionplan->id}}" data-placement="top" data-content="Delete"><i class="fa fa-trash"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                @else
...
<div class="modal fade show d-p" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-modal="true">
...
$("#deleteRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('admin/delete-subscription-plans/') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
