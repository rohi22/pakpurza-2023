...
@section('title')
Simsar | Purchases Subscription List
@endsection
                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                @if($purchasessubscriptions->count() > 0)
                                @foreach ($purchasessubscriptions as $key=>$p)
                                    <tr>
...
?>
                                        ...
                                        <td align="center">
                                           ...
                                           <?php if($p->payment_type == 1){ ?>
                                            ...
                                            <a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-type btn-danger  btn-sm btn-icon" data-toggle="kt-popover" data-id="{{$p->id}}" data-placement="top" data-content="Approve"><i class="fa fa-check"></i></button></a>
