...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('update-sell-now-field')}}" method="POST"   enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
                            ...
                            <tbody>
                                ...
                                @foreach ($setting as $key=>$s)
                                    <tr>
                                        ...
                                        <td>{{ucfirst($s->field_title)}} <input type="hidden" name="field_id[]" value="{{$s->id}}"></td>
                                        <td>
