    ...
    <div class="kt-portlet kt-portlet--height-fluid">
        ...
        <div class="kt-portlet__body">
            <div class="row p-b">
                ...
                <div class="col-md-6">
                    <form method="GET" action="{{ url('admin/all-search-products')}}">
                    <select name="status" class="ssc-box">
                    ...
                    <button class="btn btn-md btn-success" type="submit" id="myBtn">Search</button>
                    </form>
                </div>
                ...
                <div class="col-md-6 text-right">
                    <select name="" id="changeGlobalStatus" class="ssc-box">
                        <option value="">--SELECT--</option>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                             @if(!empty($sellNow->main_image))
                                                <img src="{{URL::asset('public/asset/images/sell-now/'.$sellNow->main_image)}}"  class="hw">
                                            @else
                                        ...
                                        <td align="center">
                                         ...
                                         <td align="center">
                                                <a href="{{url('ad-detail/'.$sellNow->id)}}"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y h-o" data-scroll="true" data-height="200">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-b"><div class="ps__thumb-x l-w" tabindex="0"></div></div><div class="ps__rail-y t-h" ><div class="ps__thumb-y t-r" tabindex="0"></div></div></div>
            </div>
...
<div class="modal fade show w-i" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"   aria-modal="true">
    <div class="modal-dialog modal-dialog-centered wm" role="document">
        <div class="modal-content">
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           </div>
            <div class="modal-body m-w-m">
