                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                             @if(!empty($sellNow->main_image))
                                                <img src="{{URL::asset('public/asset/images/sell-now/'.$sellNow->main_image)}}"  class="w-h">
                                            @else
                                                <img src="{{URL::asset('public/assets/media/no_image.jpg')}}"  class="h-w">
                                            @endif
...
<div class="modal fade show d-p-r" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-modal="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y h-d" data-scroll="true" data-height="200">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-b"><div class="ps__thumb-x l-w" tabindex="0" ></div></div><div class="ps__rail-y t-r-h t-h"><div class="ps__thumb-y" tabindex="0"></div></div></div>
            </div>
...
<div class="modal fade show w-p" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"   aria-modal="true">
    <div class="modal-dialog modal-dialog-centered w-m-w" role="document" >
        <div class="modal-content">
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           </div>
            <div class="modal-body m-wi">
                    ...
                    <iframe id="viewiframe" src="" allowfullscreen="true" class="w-c"></iframe>
