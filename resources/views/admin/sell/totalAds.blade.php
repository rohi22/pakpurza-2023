                                ...
                                @foreach ($ads as $key=>$sellNow)
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            @else
                                                <img src="{{URL::asset('public/assets/media/no_image.jpg')}}"  class="h-w-px">
                                            @endif
...
<div class="modal fade show" id="categoryModal d-n" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-modal="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y h-o" data-scroll="true" data-height="200" >
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-b"><div class="ps__thumb-x l-w-p" tabindex="0"></div></div><div class="ps__rail-y t-r-h"><div class="ps__thumb-y t-p-h" tabindex="0" ></div></div></div>
            </div>
...
<div class="modal fade show p-l" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"   aria-modal="true">
    <div class="modal-dialog modal-dialog-centered w-m100" role="document">
        <div class="modal-content">
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           </div>
            <div class="modal-body max-w">
                    ...
                    <iframe id="viewiframe" src="" allowfullscreen="true" class="w-he"></iframe>
