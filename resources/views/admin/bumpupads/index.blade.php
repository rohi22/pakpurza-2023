        ...
        <div class="kt-portlet__body">
            <div class="row p-b-1per" >
              ...
              <div class="col-md-2 text-right">
                   <button type="button" class="btn btn-danger" id="btbdeleteall" style="display:none"><i class="fa fa-trash"></i>delete</button></a>
                </div>
                <div class="col-md-2 text-right">
                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            <thead>
                                <tr>
                                    <th width="5%;"  class="center"><input type="checkbox" name="bumpupads" id="bumpupads">#</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($bumpupads as $key=>$bumpupad)
                                    <tr>
                                        ...
                                        <th scope="row" class="center"><input type="checkbox" value="{{$bumpupad->id}}" name="bumpupads[]" > {{$key + $bumpupads->firstItem()}}</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y h-200px" data-scroll="true" data-height="200" >
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-0px-b-365" ><div class="ps__thumb-x l-0px-w-0px" tabindex="0" ></div></div><div class="ps__rail-y " ><div class="ps__thumb-y t-130px-h-70px" tabindex="0" ></div></div></div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
           <input type="hidden" id="deleteId">
            <div class="modal-body p-t-5per-p-b-11per">
                <center>
                    <i class="la la-info-circle fb-f-s-70px"  ></i><br><br>
                    <h3>Are you sure?</h3>
                    <P>You won't be able to revert this!</P>
                    <div >
                        <button type="button" class="btn btn-primary" data-dismiss="modal">No, cancel!</button>
...
$('#btbdeleteall').click(function(){
        var values = $("input[name='bumpupads[]']:checked")
    ...
    $(document).ready(function(){
        $('#bumpupads').click(function(){
            if($(this).prop("checked") == true){
                $("[name='bumpupads[]']").attr("checked", "checked");
            }
            else if($(this).prop("checked") == false){
                $("[name='bumpupads[]']").removeAttr("checked");
            }
        });
    });
