                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            <thead>
                                <tr>
                                    <th width="5%;"  class="text-center"><input type="checkbox" name="sliders" id="sliders">#</th>
                                    <th width="37%;" class="text-center">Slide</th>
                                    <th width="25%;" class="text-center">Back Link</th>
                                    <th width="15%;"  class="text-center">Background Color</th>
                                    <th width="8%;"  class="text-center">Status</th>
                                    <th width="10%;"  lass="text-center">Actions</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($sliders as $key=>$slide)
                                    <tr>
                                        <th scope="row" class="center"><input type="checkbox" value="{{$slide->id}}" name="sliders[]" > {{$key + $sliders->firstItem()}}</th>
                                        <td align="center">
                                            @if(!empty($slide->slider))
                                                <img src="{{URL::asset('assets/media/slider/'.$slide->slider)}}"  class="h-210">
                                            @else
                                                <img src="{{URL::asset('assets/media/no_image.jpg')}}"  class="h-w-100">
                                            @endif
                                        </td>
                                        <td align="center">
                                           <a href="{{ $slide->back_link }}" target="_blank">{{ $slide->back_link }}</a>
                                        </td>
                                        <td align="center"><div style="background-color: {{ $slide->background_color }}; color:white;">Background Color</div></td>
                                        <td align="center">@if($slide->status==1) Active @else Deactive @endif</td>
                                        <td align="center">
                                            <a href="{{url('edit-slider/'.\Crypt::encrypt($slide->id))}}"><button type="button" class="btn btn-brand btn-primary btn-sm btn-icon" data-toggle="kt-popover" data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button>
                                            <a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-brand btn-danger  btn-sm btn-icon" data-toggle="kt-popover" data-id="{{$slide->id}}" data-placement="top" data-content="Delete"><i class="fa fa-trash"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                @else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y h-o" data-scroll="true" data-height="200">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-0" ><div class="ps__thumb-x l-0-w" tabindex="0" ></div></div><div class="ps__rail-y t-365"><div class="ps__thumb-y t-130" tabindex="0" ></div></div></div>
            </div>
