...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/update-banner-slots/'.$bannerslots->id)}}"  enctype="multipart/form-data"  method="POST" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                         ...
                         <label class="col-lg-2 col-form-label">Pages List</label>
                            <div class="col-lg-3">
                                <select name="page_id" class="form-control" required>
                                    ...
                                    <option value="{{$value->id}}" @if($value->id ==  $bannerslots->page_id) selected="selected"   @endif>{{ucfirst($value->page_title)}}</option>
                                    @endforeach
                                </select>
                            </div>
                    </div>
               <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text"  name="title" class="form-control" placeholder="Enter Slot Title" value="{{$bannerslots->title}}">
                    </div>
                    <!-- <label class="col-lg-2 col-form-label">Price*</label>-->
                    <!--<div class="col-lg-3">-->
                    <!--    <input type="text"  name="price" id="charges" class="form-control" placeholder="Enter Price" value="{{$bannerslots->price}}">-->
                    <!--</div>-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text"  name="slot_width" class="form-control" placeholder="Enter Slot Width" value="{{$bannerslots->slot_width}}">
                    </div>
                     <label class="col-lg-2 col-form-label">Slot Height</label>
                    <div class="col-lg-3">
                        <input type="text"  name="slot_height"  class="form-control" placeholder="Enter Slot Height" value="{{$bannerslots->slot_height}}">
                    </div>
                </div>
