        ...
        <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="dropdown dropdown-inline">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md" style="display:none;">
                        <ul class="kt-nav">
                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            <thead>
                                <tr>
                                    <th width="5%;"  class="center"><input type="checkbox" name="contact" id="contact">#</th>
                                    <th width="25%;">Full Name</th>
                                    <th width="10%;" class="center">Email</th>
                                    <th width="17%;"  class="center">Message</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($contact as $key=>$c)
                                    <tr>
                                        ...
                                        <th scope="row" class="center"><input type="checkbox" value="{{$c->id}}" name="contact[]" >   {{$key + $contact->firstItem()}}</th>
                                        <td>{{ucfirst($c->firstname)}} {{ucfirst($c->lastname)}}</td>
                                        
                                        <td> {{$c->email}}</td>
                                          <td> 
                                          <input type="hidden" name="" id="" value="{{$c->message}}" />
                                          <a href="javascript:;" class="metaKeywordsModal"  data-id="{{$c->id}}"><i class="fa fa-eye"></i></a>
...
$(".metaKeywordsModal").click(function(){
    ...
    // var id = $(this).attr('data-id');
    var metaKeywords =$(this).prevAll('input').val()
     $("#ajaxData").html(null);
...
$('#btbdeleteall').click(function(){
        var values = $("input[name='contact[]']:checked")
...
$(document).ready(function(){
        $('#contact').click(function(){
            if($(this).prop("checked") == true){
                $("[name='contact[]']").attr("checked", "checked");
            }
            else if($(this).prop("checked") == false){
                $("[name='contact[]']").removeAttr("checked");
            }
        });
    });
