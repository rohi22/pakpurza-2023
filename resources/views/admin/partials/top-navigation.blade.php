...
<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
    ...
    <!-- begin:: Aside -->
    <div class="kt-header__type kt-grid__item  bg-white" id="kt_header_type">
        <div class="kt-header__type-logo">
            <a href="{{ url('admin-dashboard') }}">
                <img alt="Logo" src="{{ asset('frontend/images/logo.png') }}" style="width: 70%;text-align:center;"/>
            </a>
        </div>
    </div>
    ...
    <!--    @if(!empty($setting->title)) {{$setting->title}} @else Simsar @endif-->
    <!--</h3>-->
    ...
    <div class="kt-header__topbar">
        ...
        <!--begin: Search -->
        <div class="kt-header__topbar-item kt-header__topbar-item--search dropdown" id="kt_quick_search_toggle" style="display:none;">
    ...
    <!--begin: Notifications -->
        <div class="kt-header__topbar-item dropdown" >
                ...
                <div class="kt-header__topbar-wrapper"data-offset="10px,0px">
                    ...
                    <span class="kt-header__topbar-icon kt-header__topbar-icon--success">
                        <a href="{{url('/')}}" target="_blank" ><i class="flaticon2-world"></i> </a>
                    </span>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
                                ...
                                <a href="#" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                        <i class="flaticon2-box-1 kt-font-type"></i>
                                    </div>
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                        ...
                        <div class="tab-pane" id="topbar_notifications_events" role="tabpanel">
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
                                ...
                                <a href="#" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                        <i class="flaticon2-favourite kt-font-type"></i>
                                    </div>
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                            New order has been placed
                            ...
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{URL::asset('public/assets/media/products/product9.jpg')}}" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{URL::asset('public/assets/media/products/product13.jpg')}}" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{URL::asset('public/assets/media/products/product16.jpg')}}" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{URL::asset('public/assets/media/products/product15.jpg')}}" title="" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="kt-mycart__footer">
                            <div class="kt-mycart__section">
                                ...
                                <div class="kt-mycart__prices">
                                    <span>$ 840.00</span>
                                    <span>$ 72.00</span>
                                    <span class="kt-font-type">$ 912.00</span>
                                </div>
                            </div>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs" style="display:none;">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon kt-header__topbar-icon--type">
                    <img class="" src="{{URL::asset('public/assets/media/flags/260-united-kingdom.svg')}}" alt="" />
                </span>
            </div>
                ...
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    <li class="kt-nav__item kt-nav__item--active">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="{{URL::asset('public/assets/media/flags/226-united-states.svg')}}" alt="" /></span>
                            <span class="kt-nav__link-text">English</span>
                        </a>
                    </li>
                    <li class="kt-nav__item">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="{{URL::asset('public/assets/media/flags/128-spain.svg')}}" alt="" /></span>
                            <span class="kt-nav__link-text">Spanish</span>
                        </a>
                    </li>
                    <li class="kt-nav__item">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="{{URL::asset('public/assets/media/flags/162-germany.svg')}}" alt="" /></span>
