                        ...
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                ...
                                @foreach ($attributes as $key=>$attribute)
                                    <input type="hidden" id="{{ $attribute->id }}" value="{{ $attribute->description }}">
                                    <tr>
                                        
                                        <th scope="row" style="text-align:center;">{{++$key}}</th>
                                        <td><a href="{{url('#')}}">{{ucfirst($attribute->attributesTitle)}}</a></td>
                                        <td align="center"><a href="javascript:;" class="descriptionModal" data-id="{{$attribute->id}}"><i class="fa fa-eye"></i></a></td>
                                        
                                        
                                        
                                        <td align="center">
                                            <!--<a href="{{url('edit-type-attributes').'/'.$attribute->attribute_id}}"><button type="button" class="btn btn-type btn-primary btn-sm btn-icon"  data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button></a>-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y height-200 overflow-hidden" data-scroll="true" data-height="200">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x left-bottom"><div class="ps__thumb-x left-width" tabindex="0"></div></div><div class="ps__rail-y height-200 top-right"><div class="ps__thumb-y top-height-70" tabindex="0"></div></div></div>
            </div>
...
$("#deleteRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('delete-subtype-attribute') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
