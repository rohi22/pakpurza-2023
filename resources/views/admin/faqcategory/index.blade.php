        ...
        <div class="kt-portlet__body">
            <div class="row p-b-1per" >
                <div class="col-md-12 text-right">
                    <a href="{{url('admin/faq-category-create')}}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Faq Category</button></a>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                ...
                                @foreach ($faqcategory as $key=>$f)
                                    <tr>
                                        
                                        <th scope="row" class="center">{{$key + $faqcategory->firstItem()}}</th>
                                        <td>{{ucfirst($f->title)}}</td>
                                        <td>@if($f->status == 1) 
                                            {{'Active'}} 
                                            @else 
                                            {{'De Active '}}
                                            @endif</td>
                                        <td align="center">
                                            <a href="{{url('admin/faq-category-edit/'.$f->id)}}"><button type="button" class="btn btn-type btn-primary btn-sm btn-icon"  data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button></a>
                                            <a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-type btn-danger  btn-sm btn-icon"  data-id="{{$f->id}}" data-placement="top" data-content="Delete"><i class="fa fa-trash"></i></button></a>
                                        </td>
...
$("#deleteRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('admin/faq-category-delete') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
