...
@section('title')
Simsar | Edit Search Featured Plans
@endsection
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    Edit Search Featured Plans
                </h3>
            </div>
        </div>

        <!--begin::Form-->
        <form action="{{url('admin/update-search-featured-listings/'.$searchfeaturedlistings->id)}}" method="POST"  enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
               ...
               <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" name="no_of_post" class="form-control" placeholder="Enter No. Of Post" value="{{$searchfeaturedlistings->no_of_post}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" name="keyword_limit" class="form-control" placeholder="Enter Keyword Limit" value="{{$searchfeaturedlistings->keyword_limit}}">
                    </div>
                </div>
