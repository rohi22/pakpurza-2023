...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/update-featured-listings/'.$featuredlistings->id)}}" method="POST" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text"  name="placement" class="form-control" placeholder="Enter Placement" value="{{$featuredlistings->placement}}">
                    </div>
                     <label class="col-lg-2 col-form-label">Charges*</label>
                    <div class="col-lg-3">
                        <input type="text"  name="charges" class="form-control" placeholder="Charges" value="{{$featuredlistings->charges}}">
                    </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="date"  name="start_date" class="form-control" placeholder="Select Start date" value="{{$featuredlistings->start_date}}">
                    </div>
                     <label class="col-lg-2 col-form-label">End Date*</label>
                    <div class="col-lg-3">
                        <input type="date"  name="end_date" class="form-control" placeholder="Select End date" value="{{$featuredlistings->end_date}}">
                    </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="time"  name="start_time" class="form-control" placeholder="Enter Title" value="{{$featuredlistings->start_time}}">
                    </div>
                     <label class="col-lg-2 col-form-label">End Time*</label>
                    <div class="col-lg-3">
                        <input type="time"  name="end_time" class="form-control" placeholder="Enter Title" value="{{$featuredlistings->end_time}}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text"  name="total" class="form-control" placeholder="Total" value="{{$featuredlistings->total}}">
                    </div>
                    
                     <label class="col-lg-2 col-form-label">status</label>
                    <div class="col-lg-3">
                        <select class="form-control w-100px" name="status"  >
                            <option value="1" @if($featuredlistings->status==1)  selected="selected" @endif>Active</option>
                            <option value="0" @if($featuredlistings->status==0)  selected="selected" @endif>De Active</option>
                         </select>
                    </div>
