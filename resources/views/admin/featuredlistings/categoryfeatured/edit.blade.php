...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/update-category-featured-listings/'.$searchfeaturedlistings->id)}}" method="POST"  enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                 ...
                 <div class="form-group row">
                    ...
                    <label class="col-lg-2 col-form-label">Category Limit</label>
                    <div class="col-lg-3">
                        <input type="number" name="category_limit" class="form-control" placeholder="Enter Category Limit" value="{{$searchfeaturedlistings->category_limit}}">
                    </div>
                </div>
                
                
                <div class="form-group row">
                    <label class="col-lg-2 col-form-label">Category Item Limit</label>
                    <div class="col-lg-3">
                        <input type="number" name="category_item_limit" class="form-control" placeholder="Enter Category Item Limit" value="{{$searchfeaturedlistings->category_item_limit}}">
                    </div>
