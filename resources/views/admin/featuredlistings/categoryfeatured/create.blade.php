...
@section('title')
Simsar | Create Category Featured  Plans
@endsection
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/save-category-featured-listings')}}" method="POST"   enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" name="category_limit" class="form-control" placeholder="Enter Category Limit">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" name="category_item_limit" class="form-control" placeholder="Enter Category Item Limit">
                    </div>
