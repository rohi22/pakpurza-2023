...
@section('title')
Simsar | Purchases Hot Featured List
@endsection
...
?>
                    ...
                    <a href="javascript:;" ><button type="button"  class="showApproveModal btn btn-type btn-danger  btn-sm btn-icon" data-toggle="kt-popover" data-id="{{$p->id}}" data-placement="top" data-content="Approve"><i class="fa fa-check"></i></button></a>
...
$("#approveRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('admin/approve-hot-plans/') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
