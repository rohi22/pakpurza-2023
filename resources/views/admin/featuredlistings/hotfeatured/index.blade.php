        ...
        <div class="kt-portlet__body">
            <div class="row p-b-1per" >
                <div class="col-md-12 text-right">
                    <a href="{{url('admin/create-hot-featured-listings')}}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Hot Featured Plans</button></a>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($searchfeaturedlistings as $key=>$searchfeaturedlisting)
                                    <tr>
                                     ...
                                     <td >{{$searchfeaturedlisting->hot_item_limit}}</td>
                                      <td >{{$searchfeaturedlisting->cost}}</td>
                                       ...
                                       <td>
                                        ...
                                        <td align="center">
                                            <a href="{{url('admin/edit-hot-featured-listings/'.$searchfeaturedlisting->id)}}"><button type="button" class="btn btn-type btn-primary btn-sm btn-icon" data-toggle="kt-popover" data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button>
...
$("#deleteRecord").click(function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ url('admin/delete-hot-featured-listings/') }}",
        data : {
        "_token": "{{ csrf_token() }}",
        "id": id,
