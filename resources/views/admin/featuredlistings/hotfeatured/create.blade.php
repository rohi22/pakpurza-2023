...
@section('title')
Simsar | Create Hot Featured Plans
@endsection
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/save-hot-featured-listings')}}" method="POST"   enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="number" name="hot_item_limit" class="form-control" placeholder="Enter Hot Item Limit">
                    </div>
                </div>
