                        ...
                        <table class="table table-bordered" width="100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%;">Type Limit</th>
                                    <th width="25%;">Type Item Limit</th>
                                    <th width="25%;">Cost</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y h-200px" data-scroll="true" data-height="200" >
                    <p id="ajaxData"></p>
                <div class="ps__rail-x l-0px-b-365" ><div class="ps__thumb-x l-0px-w-0px" tabindex="0" ></div></div><div class="ps__rail-y t-365-r-0px-h-200px" ><div class="ps__thumb-y t-130px-h-70px" tabindex="0" ></div></div></div>
            </div>
