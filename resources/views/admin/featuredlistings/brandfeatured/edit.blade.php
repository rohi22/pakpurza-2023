...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/update-type-featured-listings/'.$searchfeaturedlistings->id)}}" method="POST"  enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
               ...
               <div class="form-group row">
                    ...
                    <label class="col-lg-2 col-form-label">Type Limit</label>
                    <div class="col-lg-3">
                        <input type="number" name="brand_limit" class="form-control" placeholder="Enter Type Limit" value="{{$searchfeaturedlistings->type_limit}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                      ...
                      <label class="col-lg-2 col-form-label">Type Item Limit</label>
                    <div class="col-lg-3">
                        <input type="number" name="brand_item_limit" class="form-control" placeholder="Enter Type Item Limit" value="{{$searchfeaturedlistings->type_item_limit}}">
                    </div>
