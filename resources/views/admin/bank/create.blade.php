...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{ route('admin.bank.store') }}" method="POST"  class="kt-form kt-form--fit kt-form--label-right"  >
            @csrf
            <div class="kt-portlet__body">
                <div class="row pb-1-percentage">
                    <div class="col-md-12 text-right">
                        <a href="{{route('admin.bank.index')}}"><button type="button" class="btn btn-primary"><i class="fa fa-eye"></i>Manage Banks</button></a>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ac_title"  class="form-control" >
                        </div>
                        <div class="form-group">
