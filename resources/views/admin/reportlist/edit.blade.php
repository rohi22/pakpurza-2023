...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('update-report-setting/'.$adReport->id)}}" method="POST"  enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text"  name="title" class="form-control" value="{{$adReport->report}}" placeholder="Enter Title">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <select class="form-control kt-select2" name="status" id="kt_select2" name="select2">
                            <option value="1" @if($adReport->status_id==1)  selected="selected" @endif>Active</option>
                            <option value="0" @if($adReport->status_id==0)  selected="selected" @endif>De Active</option>
                        </select>
                    </div>
                 </div>
