        ...
        <div class="kt-portlet__body">
            <div class="row" style="padding-bottom:1%;">
                ...
                <div class="col-md-2 text-right">
                    <a href="{{url('create-report-setting')}}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add Report</button></a>
                </div>
            </div>
                ...
                <div class="kt-section__content">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%;">
                            ...
                            <tbody>
                                @if($adReport->count() > 0)
                                @foreach ($adReport as $key=>$a)
                                    <tr>
                                     
                                        <th scope="row" style="text-align:center;"><input type="checkbox" value="{{$a->id}}" name="adReport[]" > {{$key + $adReport->firstItem()}}</th>
                                        <td>{{$a->report}}</td>
                                        ...
                                        <td align="center">
                                            <a href="{{url('edit-report-setting/'.$a->id)}}"><button type="button" class="btn btn-brand btn-primary btn-sm btn-icon" data-toggle="kt-popover" data-placement="top" data-content="Edit"><i class="fa fa-edit"></i></button>
                                            <a href="javascript:;" ><button type="button"  class="showDeleteModal btn btn-brand btn-danger  btn-sm btn-icon" data-toggle="kt-popover" data-id="{{$a->id}}" data-placement="top" data-content="Delete"><i class="fa fa-trash"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                @else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="kt-scroll ps ps--active-y" data-scroll="true" data-height="200" style="height: 200px; overflow: hidden;">
                    <p id="ajaxData"></p>
                <div class="ps__rail-x" style="left: 0px; bottom: -365px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 365px; right: 0px; height: 200px;"><div class="ps__thumb-y" tabindex="0" style="top: 130px; height: 70px;"></div></div></div>
            </div>
...
$('#btbdeleteall').click(function(){
        var values = $("input[name='adReport[]']:checked")
