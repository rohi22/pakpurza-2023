...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form action="{{url('admin/update-types/'.$brand->id)}}" method="POST"  enctype="multipart/form-data" class="kt-form kt-form--fit kt-form--label-right"  >
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <input type="text"  name="meta_title" class="form-control" placeholder="Enter Title" value="{{$brand->meta_title}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <textarea id="kt_maxlength_1" name="meta_description" class="form-control"  maxlength="255" placeholder="" rows="2" placeholder="Enter Description">{{$brand->meta_description}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-lg-2 col-form-label">Image Logo*</label>
                    <div class="col-lg-3">
                     
                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                            <div class="kt-avatar__holder" style="background-image: url('{{URL::asset('public/assets/media/brand/logo/'.$brand->image_logo)}}')"></div>
                             <!--<div class="kt-avatar__holder" style="background-image: url('http://simsar.com/testsimsar/public/assets/media/type/logo/{{$brand->image_logo.'\''}});"></div>-->
                    ...
                    <div class="col-lg-3">
                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_2">
                            <div class="kt-avatar__holder" style="background-image: url('{{URL::asset('public/assets/media/brand/banner/'.$brand->image_banner)}}')"></div>
                            <!--<div class="kt-avatar__holder" style="background-image: url('http://simsar.com/testsimsar/public/assets/media/type/banner/{{$brand->image_banner.'\''}});"></div>-->
                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
                                <i class="fa fa-pen"></i>
                                <input type="file" name="banner" class="checkImageValid w-100per" id="upload_image_second" required>
                    ...
                    <div class="col-lg-3">
                        <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_3">
                            <div class="kt-avatar__holder" style="background-image: url('http://minibigerp.com/simsar/testsimsar/public/assets/media/type/banner/{{$brand->image.'\''}});"></div>
                            <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
                                <i class="fa fa-pen"></i>
                                <input type="file" name="image" class="checkImageValid w-100per" id="upload_image_third" required>
                                <input type="hidden" name="imgNamee" id="imgNamee" />
                            </label>
                            <span class="kt-avatar__cancel" data-toggle="kt-tooltip" title="" data-original-title="Cancel avatar">
                                <i class="fa fa-times"></i>
                            </span>
  ...
  $('#upload_image_second').on('change', function() {
    ...
    $('#upload_image_first').on('change', function() {
     ...
     $('#deleteModal').css('display', 'none');
         ...
         $('#upload_image_third').on('change', function() {
        	var reader = new FileReader();
        	reader.onload = function(event) {
        		$image_crop.croppie('bind', {
        			url: event.target.result
