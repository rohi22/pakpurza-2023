...
<html lang="en">
	...
	<head>
		<base href="../../../">
		<meta charset="utf-8" />
		<title>Pakpurza | Admin Login</title>
		...
		<div class="kt-grid kt-grid--ver kt-grid--root kt-page">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
					...
					<!--begin::Aside-->
					{{-- <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{asset('assets/images/1190187206029892.A6EwcWk9HjgZG14WZW47_height640.png')}});"> --}}
					<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{asset('frontend/images/banner2.png')}});">
				
						<div class="kt-grid__item">
							<a href="#" class="kt-login__logo">
								<!--<img src="{{asset('assets/media/logos/logo-4.png')}}">-->
                                {{-- <h1 style="color:#fff">Pakpurza</h1> --}}
								<img src="{{asset('frontend/images/logo.png')}}" style="margin: 0px 137px;">
							</a>
						</div>
						<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
							<div class="kt-grid__item kt-grid__item--middle">
								<h3 class="kt-login__title">Welcome to Pakpurza admin dashboard! </h3>
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								<div class="kt-login__title">
								    {{-- <img class="m-20px-m-width" src="{{asset('assets/media/web-settings/1589655042Simsar_logo.png')}}"> --}}
									<!--<h3>Sign In</h3>-->
								</div>
