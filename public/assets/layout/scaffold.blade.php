...
<html lang="en">
	...
	<head>
		...
		<link href="{{URL::asset('public/admin_assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />

		<!--end::Page Vendors Styles -->

		<!--begin::Global Theme Styles(used by all pages) -->
		<link href="{{URL::asset('public/admin_assets/plugins/global/plugins.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{URL::asset('public/admin_assets/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="{{URL::asset('public/admin_assets/media/logos/favicon.ico')}}" />
	</head>
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="index.html">
					<img alt="Logo" src="{{URL::asset('public/admin_assets/media/logos/logo-6-sm.png')}}"" />
				</a>
			</div>
					...
					<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
						...
						<div class="kt-header__brand kt-grid__item  " id="kt_header_brand">
							<div class="kt-header__brand-logo">
								<a href="index.html">
									<img alt="Logo" src="{{URL::asset('public/admin_assets/media/logos/logo-6.png')}}" />
								</a>
							</div>
						</div>
						...
						<div class="kt-header__topbar">
												...
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="{{URL::asset('public/admin_assets/media/products/product9.jpg')}}" title="">
														</a>
													</div>
												</div>
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="{{URL::asset('public/admin_assets/media/products/product13.jpg')}}" title="">
														</a>
													</div>
												</div>
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="{{URL::asset('public/admin_assets/media/products/product16.jpg')}}" title="">
														</a>
													</div>
												</div>
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="{{URL::asset('public/admin_assets/media/products/product15.jpg')}}" title="" alt="">
														</a>
													</div>
												</div>
											</div>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--langs">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon kt-header__topbar-icon--brand">
										<img class="" src="{{URL::asset('public/admin_assets/media/flags/260-united-kingdom.svg')}}" alt="" />
									</span>
								</div>
									...
									<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
										<li class="kt-nav__item kt-nav__item--active">
											<a href="#" class="kt-nav__link">
												<span class="kt-nav__link-icon"><img src="{{URL::asset('public/admin_assets/media/flags/226-united-states.svg')}}" alt="" /></span>
												<span class="kt-nav__link-text">English</span>
											</a>
										</li>
										<li class="kt-nav__item">
											<a href="#" class="kt-nav__link">
												<span class="kt-nav__link-icon"><img src="{{URL::asset('public/admin_assets/media/flags/128-spain.svg')}}" alt="" /></span>
												<span class="kt-nav__link-text">Spanish</span>
											</a>
										</li>
										<li class="kt-nav__item">
											<a href="#" class="kt-nav__link">
												<span class="kt-nav__link-icon"><img src="{{URL::asset('public/admin_assets/media/flags/162-germany.svg')}}" alt="" /></span>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									...
									<img class="kt-hidden" alt="Pic" src="{{URL::asset('public/admin_assets/media/users/300_21.jpg')}}" />
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
									...
									<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(assets/media/misc/bg-1.jpg)">
										<div class="kt-user-card__avatar">
											<img class="kt-hidden" alt="Pic" src="{{URL::asset('public/admin_assets/media/users/300_25.jpg')}}" />
											...
											<div class="kt-widget4">
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--icon">
														<img src="{{URL::asset('public/admin_assets/media/files/doc.svg')}}" alt="">
													</div>
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--icon">
														<img src="{{URL::asset('public/admin_assets/media/files/jpg.svg')}}" alt="">
													</div>
													<a href="#" class="kt-widget4__title">
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--icon">
														<img src="{{URL::asset('public/admin_assets/media/files/pdf.svg')}}" alt="">
													</div>
													<a href="#" class="kt-widget4__title">
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--icon">
														<img src="{{URL::asset('public/admin_assets/media/files/javascript.svg')}}" alt="">
													</div>
													<a href="#" class="kt-widget4__title">
														Make JS Development
													</a>
												...
												<div class="kt-widget4__item">
													<div class="kt-widget4__pic kt-widget4__pic--icon">
														<img src="{{URL::asset('public/admin_assets/media/files/zip.svg')}}" alt="">
													</div>
													<a href="#" class="kt-widget4__title">
											...
											<div class="tab-content">
													...
													<div class="kt-widget4">
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_4.jpg')}}" alt="">
															</div>
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_14.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Milano Esco
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_11.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Bold
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_1.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Wiltor Delton
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_5.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Stone
												...
												<div class="tab-pane" id="kt_widget4_tab2_content">
													<div class="kt-widget4">
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_2.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Kristika Bold
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_13.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Ron Silk
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_9.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Bold
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="{{URL::asset('public/admin_assets/media/users/100_8.jpg')}}" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Bold
											...
											<div class="kt-widget19__wrapper">
												<div class="kt-widget19__content">
													<div class="kt-widget19__userpic">
														<img src="{{URL::asset('public/admin_assets/media/users/user1.jpg')}}" alt="">
													</div>
												...
												<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
													...
													<div class="kt-timeline-v2__item">
														...
														<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
															<a href="#"><img src="{{URL::asset('public/admin_assets/media/users/100_4.jpg')}}" title=""></a>
															<a href="#"><img src="{{URL::asset('public/admin_assets/media/users/100_13.jpg')}}" title=""></a>
															<a href="#"><img src="{{URL::asset('public/admin_assets/media/users/100_11.jpg')}}" title=""></a>
															<a href="#"><img src="{{URL::asset('public/admin_assets/media/users/100_14.jpg')}}" title=""></a>
														</div>
													</div>
													<div class="kt-timeline-v2__item">
			...
			<div class="kt-demo-panel__body">
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo1.jpg')}}" alt="" />
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo2.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo3.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo4.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo5.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item kt-demo-panel__item--active">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo6.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo7.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo8.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo9.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo10.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo11.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo12.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo13.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo14.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo15.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo16.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo17.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo18.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo19.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo20.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo21.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{URL::asset('public/admin_assets/media//demos/preview/demo22.jpg')}}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
									...
									<div class="kt-chat__messages kt-chat__messages--solid">
										<div class="kt-chat__message kt-chat__message--success">
											<div class="kt-chat__user">
												<span class="kt-media kt-media--circle kt-media--sm">
													<img src="{{URL::asset('public/admin_assets/media/users/100_12.jpg" alt="image">
												</span>
										...
										<div class="kt-chat__message kt-chat__message--right kt-chat__message--brand">
											<div class="kt-chat__user">
												...
												<span class="kt-media kt-media--circle kt-media--sm">
													<img src="{{URL::asset('public/admin_assets/media/users/300_21.jpg" alt="image">
												</span>
											</div>
											<div class="kt-chat__text">
		...
		<script src="{{URL::asset('public/admin_assets/plugins/global/plugins.bundle.js')}}" type="text/javascript"></script>
		<script src="{{URL::asset('public/admin_assets/js/scripts.bundle.js')}}" type="text/javascript"></script>

		<!--end::Global Theme Bundle -->

		<!--begin::Page Vendors(used by this page) -->
		<script src="{{URL::asset('public/admin_assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}" type="text/javascript"></script>
		<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript"></script>
		<script src="{{URL::asset('public/admin_assets/plugins/custom/gmaps/gmaps.js')}}" type="text/javascript"></script>

		<!--end::Page Vendors -->

		<!--begin::Page Scripts(used by this page) -->
		<script src="{{URL::asset('public/admin_assets/js/pages/dashboard.js')}}" type="text/javascript"></script>
