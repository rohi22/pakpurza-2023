...
var KTFormWidgets = function () {
    ...
    var initWidgets = function() {
        ...
        $('#kt_select2_2').on('select2:change', function(){
        ...
        $('#kt_title').bind('title:select', function(ev, suggestion) {

            validator.element($('#kt_title')); // validate element
